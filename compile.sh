...
g++ -Wall -Wextra -o executables/score_only -std=c++11 -O4 score_only.cpp nt_wrappers/nt_wrappers.a edge_sampler.cpp scoring_function.cpp wl_measures.cpp Jonker_Volgenant/src/assign2DCBasic.c int_edge_sampler.cpp thread_pool_wl_sim.cpp thread_pool_scorer.cpp noise_prob_choice.cpp -lpthread

g++ -Wall -Wextra -o executables/main -std=c++11 -O4 main.cpp nt_wrappers/nt_wrappers.a edge_sampler.cpp scoring_function.cpp wl_measures.cpp Jonker_Volgenant/src/assign2DCBasic.c int_edge_sampler.cpp thread_pool_scorer.cpp thread_pool_wl_sim.cpp noise_prob_choice.cpp genetic_alg_search.cpp -lpthread
