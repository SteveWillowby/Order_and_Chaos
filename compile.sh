...
g++ -Wall -Wextra -o executables/main -std=c++11 -O4 main.cpp nt_partition.cpp graph.cpp sparse_graph.cpp nt_sparse_graph.cpp nauty_traces.cpp file_utils.cpp edge_sampler.cpp scoring_function.cpp thread_pool_scorer.cpp genetic_alg_search.cpp simulated_annealing_search.cpp nauty27r4_modified/nauty.a
