...
# Create a library
ar rvs scheno.a edge_sampler.o genetic_alg_search.o int_edge_sampler.o noise_prob_choice.o scoring_function.o thread_pool_scorer.o thread_pool_wl_sim.o wl_measures.o assign2DCBasic.o
