...
__graphs_list__ = ["SUBDUE_sanity_check.txt", \
                   "karate.txt", "season_4_undirected_edges.txt", \
...
__name_list__ =   ["subdue_sanity_check", \
                   "karate", "season_4", "foodweb", "pol_blogs", "eucore", \
    ...
    for i in range(0, num_rounds):
        ...
        if rand_graphs:
            ...
            if __name_list__[i] in ["enron", "flickr", "epinions"] and \
                ...
                continue
            if __name_list__[i].lower() in \
                    ["fullerene_c180", "fullerene_c720", "fullerene_c6000", \
                     "subdue_sanity_check"] and \
        ...
        print("#Und. Edges: %d" % \
                len(set([(min(a, b), max(a, b)) for (a, b) in edges])))
