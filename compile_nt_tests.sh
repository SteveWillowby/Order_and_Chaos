...
g++ -Wall -Wextra -o minimal_nt_example -std=c++11 minimal_nt_example.cpp nt_partition.cpp graph.cpp sparse_graph.cpp nt_sparse_graph.cpp nauty_traces.cpp file_utils.cpp nauty27r4_modified/nauty.a
