...
nice -2 executables/main_jazz_undir >> test_results/jazz_undir.txt
rm test_results/c_elegans_dir.txt
nice -2 executables/main_c_elegans_dir >> test_results/c_elegans_dir.txt
rm test_results/species_brain_dir.txt
nice -2 executables/main_species_brain_dir >> test_results/species_brain_dir.txt
